...
where (hyperinflated + edema + emphysema + cardiomegaly + congestive + bronchitis + effusion + atelectasis + chf + pedicle) > 0
order by (hyperinflated + edema + emphysema + cardiomegaly + congestive + bronchitis + effusion + atelectasis + chf + pedicle) desc
limit 250
